...
def load_model_h5(model_path, model_file):
...
loaded_model_vgg16 = load_model_h5(MODEL_VGG16_PATH, MODEL_VGG16_FILE)
...
loaded_model_cnn = load_model_h5(MODEL_CNN_PATH, MODEL_CNN_FILE)
